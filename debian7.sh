...
wget -O /etc/nginx/nginx.conf "http://sshaiopremium.ga/script/debian7/nginx.conf"
...
# install openvpn
wget -O /etc/openvpn/openvpn.tar "http://sshaiopremium.ga/script/debian7/openvpn.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "http://sshaiopremium.ga/script/debian7/1194-debian.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.up.rules "http://sshaiopremium.ga/script/debian7/iptables.up.rules"
...
#konfigurasi openvpn
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn "http://sshaiopremium.ga/script/debian7/1194-client.conf"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "http://sshaiopremium.ga/script/debian7/badvpn-udpgw"
sed -i '$ i\screen -AmdS badvpn badvpn-udpgw --listen-addr 127.0.0.1:7300' /etc/rc.local
chmod +x /usr/bin/badvpn-udpgw
screen -AmdS badvpn badvpn-udpgw --listen-addr 127.0.0.1:7300

# install mrtg
wget -O /etc/snmpd.conf "http://sshaiopremium.ga/script/debian7/snmpd.conf"
wget -O /root/mrtg-mem.sh "http://sshaiopremium.ga/script/debian7/mrtg-mem.sh"
...
curl "http://sshaiopremium.ga/script/debian7/mrtg.conf" >> /etc/mrtg.cfg
...
wget -O /etc/squid3/squid.conf "http://sshaiopremium.ga/script/debian7/squid.conf"
...
cd
wget http://sshaiopremium.ga/script/debian7/config/userunban
...
cd
wget http://sshaiopremium.ga/script/debian7/config/alluserpptp
...
wget http://sshaiopremium.ga/script/debian7/config/speedtest.py
...
wget -O /etc/issue.net "http://sshaiopremium.ga/aio/config/banner"
